...
export function ActionCircleButton({ variant, onClick, ariaLabel }: ActionButtonProps) {
  return (
...
export function ActionSimpleButton({ variant, onClick, ariaLabel }: ActionButtonProps) {
  return (
